...
1. Head over to the [project page](https://app.bigdevsoon.me/projects/level-editor). Choose between Freerun or Speedrun mode, then click either the "Start Freerun" or "Start Speedrun" button.
